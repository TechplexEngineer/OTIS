...
//    oTop = o.offsetTop + o.offsetHeight
//    while (o.offsetParent != null) {
//        oParent = o.offsetParent
...
//    var left = getAbsoluteLeft('nav-list') - 1;
//    var width = $('#nav-list').width() - 20 + 6;
//    $('#' + dropObject).css({
//        left: left + "px",
//        top: "29px",
//        width: width
...
//    });
    ...
    function highlight(elemId) {
        $(elemId).css("backgroundColor", "#ffffff");
        $(elemId).animate({
